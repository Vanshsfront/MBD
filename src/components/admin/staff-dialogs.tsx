...
// Calendar colour picker. `value` is an explicit hex or "" (auto). When
// auto, the preview shows the deterministic fallback derived from the staff
// id (or the first palette colour for brand-new staff with no id yet).
